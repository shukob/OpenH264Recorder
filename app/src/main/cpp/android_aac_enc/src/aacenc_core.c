...
/*******************************************************************************
	...
	Content:	aac h264Encoder core functions
...
* description:  allocate and initialize a new h264Encoder instance
* returns:      0 if success
*
**********************************************************************************/
Word16  AacEncOpen(  AAC_ENCODER*      hAacEnc,        /* pointer to an h264Encoder handle, initialized on return */
                     ...
                     )
{
  ...
  if (!error) {
	...
	/* init h264Encoder psychoacoustic */
...
*
**********************************************************************************/
Word16 AacEncEncode(AAC_ENCODER *aacEnc,		/*!< an h264Encoder handle */
...
* description: deallocate an h264Encoder instance
*
**********************************************************************************/
